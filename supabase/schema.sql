...
-- 7. School to-dos (same shape as todos)
...
-- 8. School upcoming due dates (always displayed sorted by date, not position)
...
-- 9. School important links (reorderable, opens in a new tab)
